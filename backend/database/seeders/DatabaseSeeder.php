...
class DatabaseSeeder extends Seeder
{
    ...
    {
        $destinations = [
            ['University of Moratuwa', 'campus', 6.7969, 79.9018], ['University of Colombo', 'campus', 6.9003, 79.8587],
            ['University of Sri Jayewardenepura', 'campus', 6.8528, 79.9036], ['SLIIT Malabe Campus', 'campus', 6.9147, 79.9739],
            ['NSBM Green University', 'campus', 6.8213, 80.0407], ['University of Kelaniya', 'campus', 6.9749, 79.9159],
            ['University of Peradeniya', 'campus', 7.2541, 80.5974], ['University of Ruhuna', 'campus', 5.9383, 80.5763],
            ['University of Jaffna', 'campus', 9.6849, 80.0220], ['Kotelawala Defence University', 'campus', 6.8207, 79.8868],
            ['World Trade Center Colombo', 'workplace', 6.9320, 79.8440], ['Orion City IT Park', 'workplace', 6.9466, 79.8795],
            ['TRACE Expert City', 'workplace', 6.9270, 79.8624], ['Kandy City Centre', 'workplace', 7.2938, 80.6407],
            ['Galle City Centre', 'workplace', 6.0329, 80.2168], ['Colombo South Teaching Hospital', 'workplace', 6.8667, 79.8771],
            ['National Hospital of Sri Lanka', 'workplace', 6.9187, 79.8685], ['Teaching Hospital Karapitiya', 'workplace', 6.0669, 80.2261],
        ];
        foreach ($destinations as [$name, $type, $latitude, $longitude]) {
            Institution::query()->updateOrCreate(['name' => $name], ['type' => $type, 'latitude' => $latitude, 'longitude' => $longitude, 'active' => true]);
        }
