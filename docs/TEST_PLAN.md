...
|---|---|---|
| Laravel feature/security/contract | `php artisan test` | 39 passed, 567 assertions |
...
- PHP↔Flask ranking and index lifecycle contract, including campus/workplace interpretation, ordered Haversine eligibility, multimodal commute estimates and nine categories of nearby essentials with provenance fields.
...
- Hard/preferred/excluded facility semantics, Sinhala-English intent, transparent route modes, private feedback learning, consented-query anonymization, trained intent labels and advisory listing-risk evidence.
