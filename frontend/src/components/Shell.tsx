...
type AssistantMessage = { id: number; role: 'assistant' | 'user'; text: string; results?: Listing[]; prompts?: string[]; disclaimer?: string };
type AssistantResponse = { answer: string; results: Listing[]; suggestions?: Array<{ name: string }>; disclaimer: string };
